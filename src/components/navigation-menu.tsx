...
type NavigationMenuLinkProps = React.ComponentPropsWithoutRef<
	typeof NavigationMenuPrimitive.NavigationMenuLink
>;
...
export const NavigationMenu = React.forwardRef<NavigationMenuRef, NavigationMenuProps>(
...
export const NavigationMenuLink = React.forwardRef<NavigationMenuLinkRef, NavigationMenuLinkProps>(
	({ className, children, ...props }, ref) => (
...
export const NavigationMenuList = React.forwardRef<NavigationMenuListRef, NavigationMenuListProps>(
	({ className, ...props }, ref) => (
